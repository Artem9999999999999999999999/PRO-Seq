...
```{r}
Counts <- read.delim("data_r6.53/featureCounts_r6_53.csv", header = TRUE, row.names = 1, sep = ",")
...
```{r}
plotMA(CHD1_resLFC, ylim = c(-7, 7), main = "MA Plot for CHD1 (r6.53)")
plotMA(S2_resLFC, ylim = c(-4, 4), main = "MA Plot for S2(r6.53)")
```
...
```{r}
results_folder <- "results_r6.53"
file_path <- file.path(results_folder, "summary_table(r6.53).csv")
...
```{r}
annotation_file <- "data_r6.53/dmel-all-r6.53.gtf.gz"
...
```{r}
file_path_CHD1 <- "results_r6.53/diff_expr_CHD1(r6.53).csv"
...
ggplot(filtered_counts_CHD1_up.df, aes(x = group, y = log2FoldChange, fill = group)) +
  geom_boxplot() +
  labs(title = paste("Boxplot of log2FoldChange for DE genes of Chd1 UP (r6.53) (N =", nrow(filtered_counts_CHD1_up.df), ")", sep = ""), x = "Group", y = "log2FoldChange") +
...
ggplot(filtered_counts_CHD1_down.df, aes(x = group, y = log2FoldChange, fill = group)) +
  geom_boxplot() +
  labs(title = paste("Boxplot of log2FoldChange for DE genes of Chd1 DOWN (r6.53) (N =", nrow(filtered_counts_CHD1_down.df), ")", sep = ""), x = "Group", y = "log2FoldChange") +
  scale_fill_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  ylim(-1, 0)
```
...
ggplot(filtered_counts_CHD1_up.df, aes(x = log2FoldChange, color = group)) +
  ...
  labs(title = paste("Density Plot of log2FoldChange for DE genes of  Chd1 UP (r6.53) (N =", nrow(filtered_counts_CHD1_down.df), ")", sep = ""), x = "log2FoldChange", y = "Density") +
...
ggplot(filtered_counts_CHD1_down.df, aes(x = log2FoldChange, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = paste("Density Plot of log2FoldChange for DE genes of  Chd1 DOWN (r6.53)(N =", nrow(filtered_counts_CHD1_down.df), ")", sep = ""), x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(-1, 0)
```
...
```{r}
figures_folder <- "figures_r6.53"

if (!file.exists(figures_folder)) {
  dir.create(figures_folder)
}

boxplot_path_up <- file.path(figures_folder, "Boxplot_DE_chd1_up(r6.53).png")
boxplot_path_down <- file.path(figures_folder, "Boxplot_DE_chd1_down(r6.53).png")
density_plot_path_up <- file.path(figures_folder, "Density_plot_DE_chd1_up(r6.53).png")
density_plot_path_down <- file.path(figures_folder, "Density_plot_DE_chd1_down(r6.53).png")


png(boxplot_path_up)
ggplot(filtered_counts_CHD1_up.df, aes(x = group, y = log2FoldChange, fill = group)) +
  geom_boxplot() +
  labs(title = paste("Boxplot of log2FC for DE genes of Chd1 UP(r6.53) (N =", nrow(filtered_counts_CHD1_up.df), ")", sep = ""), x = "Group", y = "log2FoldChange") +
  scale_fill_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  ylim(0, 1)
dev.off()
...
ggplot(filtered_counts_CHD1_down.df, aes(x = group, y = log2FoldChange, fill = group)) +
  geom_boxplot() +
  labs(title = paste("Boxplot of log2FC for DE genes of Chd1 DOWN(r6.53) (N =", nrow(filtered_counts_CHD1_down.df), ")", sep = ""), x = "Group", y = "log2FoldChange") +
  scale_fill_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  ylim(-1, 0)
dev.off()
...
ggplot(filtered_counts_CHD1_up.df, aes(x = log2FoldChange, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = paste("Density Plot of log2FC for DE genes of  Chd1 UP(r6.53) (N =", nrow(filtered_counts_CHD1_up.df), ")", sep = ""), x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(0, 2)
dev.off()
...
ggplot(filtered_counts_CHD1_down.df, aes(x = log2FoldChange, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = paste("Density Plot of log2FC for DE genes of  Chd1 DOWN(r6.53) (N =", nrow(filtered_counts_CHD1_down.df), ")", sep = ""), x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(-2, 0)
dev.off()
...
file_path <- file.path(results_folder, "tpm_chr_table_chd1(r6.53).csv")
...
filtered_counts_CHD1 <- Counts_CHD1_IA_tpm_combined.df %>%
  filter(Chd1_Ctrl1_r653 > 1, Chd1_Auxin1_r653 > 1, Chd1_Ctrl2_r653 > 1, Chd1_Auxin2_r653 > 1)
```

```{r}
filtred_counts_avg_CHD1 <- filtered_counts_CHD1 %>%
  mutate(Ctrl = (Chd1_Ctrl1_r653 + Chd1_Ctrl2_r653) / 2, 
         Auxin = (Chd1_Auxin1_r653 + Chd1_Auxin2_r653) / 2)
...
ggplot(filtred_counts_avg_CHD1, aes(x = group, y = log2FC, fill = group)) +
  geom_boxplot() +
  labs(title = "Boxplot of log2FoldChange for TPM Chd(r6.53)1", x = "Group", y = "log2FoldChange") +
  scale_fill_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  ylim(-1, 1)
```
...
```{r}
file_path <- file.path(results_folder, "tpm_chr_table_s2(r6.53).csv")
...
filtered_counts_S2 <- Counts_S2_IA_tpm_combined.df %>%
  filter(S2_Ctrl1_r653 > 1, S2_Auxin1_r653 > 1, S2_Ctrl2_r653 > 1, S2_Auxin2_r653 > 1)
```

```{r}
filtred_counts_avg_S2 <- filtered_counts_S2 %>%
  mutate(Ctrl = (S2_Ctrl1_r653 + S2_Ctrl2_r653) / 2, 
         Auxin = (S2_Auxin1_r653 + S2_Auxin2_r653) / 2)
...
ggplot(filtred_counts_avg_S2, aes(x = group, y = log2FC, fill = group)) +
  geom_boxplot() +
  labs(title = "Boxplot of log2FoldChange for TPM S2(r6.53)", x = "Group", y = "log2FoldChange") +
  scale_fill_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  ylim(-1, 1)
```
...
ggplot(filtred_counts_avg_S2, aes(x = log2FC, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = "Density Plot of log2FoldChange for TPM S2(r6.53)", x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(-1, 1)
```
...
boxplot_path_tpm_s2 <- file.path(figures_folder, "Boxplot_TPM_s2(r6.53).png")
density_plot_path_tpm_s2 <- file.path(figures_folder, "Density_plot_TPM_s2(r6.53).png")
...
ggplot(filtered_data_CHD1, aes(x = log2FC, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = "Density Plot of log2FoldChange for TPM Chd1(r6.53) (HK genes)", x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(-1, 1)
```
...
ggplot(filtered_data_S2, aes(x = log2FC, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = "Density Plot of log2FoldChange for TPM S2(r6.53) (HK genes)", x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(-1, 1)
```
...
density_plot_path_tpm_s2_hk <- file.path(figures_folder, "Density_plot_TPM_s2(r6.53)_HK.png")
