...
```{r}
Counts <- read.delim("data/featurecounts_hisat2.csv", header = TRUE, row.names = 1, sep = ",")
...
```{r}
file_path_CHD1 <- "results/diff_expr_CHD1_Hisat2.csv"
file_path_S2 <- "results/diff_expr_S2_Hisat2.csv"
...
ggplot(filtered_counts_CHD1.df, aes(x = group, y = log2FoldChange, fill = group)) +
  geom_boxplot() +
  labs(title = "Boxplot of log2FoldChange for DE genes of Chd1 Hisat2", x = "Group", y = "log2FoldChange") +
...
ggplot(filtered_counts_CHD1.df, aes(x = log2FoldChange, color = group)) +
  ...
  labs(title = "Density Plot of log2FoldChange for DE genes of  Chd1 Hisat2", x = "log2FoldChange", y = "Density") +
...
plot_path_s2 <- file.path(figures_folder, "MA_Plot_S2_Hisat2.png")
plot_path_chd1 <- file.path(figures_folder, "MA_Plot_Chd1_Hisat2.png")
plot_path_PCA <- file.path(figures_folder, "PCA_Plot_Hisat2.png")
boxplot_path <- file.path(figures_folder, "Boxplot_DE_chd1_Hisat2.png")
density_plot_path <- file.path(figures_folder, "Density_plot_DE_chd1_Hisat2.png")
...
png(plot_path_chd1)
plotMA(CHD1_resLFC, ylim = c(-6, 6), main = "MA Plot for CHD1 Hisat2")
dev.off()
...
ggplot(filtered_counts_CHD1.df, aes(x = group, y = log2FoldChange, fill = group)) +
  geom_boxplot() +
  labs(title = "Boxplot of log2FoldChange for DE Chd1 Hisat2", x = "Group", y = "log2FoldChange") +
  scale_fill_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  ylim(-1, 1)
dev.off()
...
ggplot(filtered_counts_CHD1.df, aes(x = log2FoldChange, color = group)) +
  geom_density(alpha = 0, size = 1) + 
  labs(title = "Density Plot of log2FoldChange for DE Chd1 Hisat2", x = "log2FoldChange", y = "Density") +
  scale_color_manual(values = color_palette, name = "Group") +
  theme_minimal() +
  xlim(-1, 1)
dev.off
